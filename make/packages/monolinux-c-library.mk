...
MONOLINUX_C_LIBRARY_CFLAGS_EXTRA += -DML_LOG_OBJECT_TXT='$(MONOLINUX_C_LIBRARY_LOG_OBJECT_TXT)'
MONOLINUX_C_LIBRARY_CFLAGS_EXTRA += -I$(SYSROOT)/include
...
$(MONOLINUX_C_LIBRARY_BUILD): $(MONOLINUX_C_LIBRARY_RSYNC)
	...
	$(MAKE) -C $(PACKAGES_DIR)/monolinux-c-library library \
	    ...
	    CFLAGS_EXTRA="$(MONOLINUX_C_LIBRARY_CFLAGS_EXTRA)"
